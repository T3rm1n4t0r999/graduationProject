...
export default function AuthenticatedLayout({ header, children }) {
    ...
    return (
        <div className="min-h-screen" style={{ background: 'var(--color-bg)' }}>
            {/* Декоративные элементы фона – оставлены для мягкости */}
            ...
            <nav className="glass-header sticky top-0 z-30">
                    ...
                    <div className="flex h-16 justify-between">
                                ...
                                <Dropdown>
                                    <Dropdown.Trigger>
                                        <span className="inline-flex rounded-xl">
                                            <button
                                                type="button"
                                                className="inline-flex items-center gap-2 rounded-xl border px-4 py-2 text-sm font-medium transition duration-150 ease-in-out"
                                                style={{
                                    ...
                                    <Dropdown.Content className="dropdown-glass z-50">
                        ...
                        <div className="-me-2 flex items-center sm:hidden">
                            <button
                                ...
                                className="inline-flex items-center justify-center rounded-md p-2 text-gray-400 transition duration-150 ease-in-out hover:bg-gray-100 hover:text-gray-500 focus:outline-none dark:text-gray-500 dark:hover:bg-gray-900 dark:hover:text-gray-400"
                            >
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    ...
                    <div className="border-t border-gray-200 pb-1 pt-4 dark:border-gray-600">
                        <div className="px-4">
                            <div className="text-base font-medium text-main">{user.name}</div>
                            <div className="text-sm font-medium text-meta">{user.email}</div>
                        </div>
            ...
            {header && (
                <header className="sticky top-16 z-20"
                        style={{
                            background: 'var(--color-bg-card)',
