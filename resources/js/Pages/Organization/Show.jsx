            ...
            header={
                <div className="flex justify-between items-center flex-wrap gap-4">
                    ...
                    <div className="flex gap-3">
                        <a
                            href={route('organization.admin', {organization: organization.id})}
                            className="bg-emerald-500 hover:bg-emerald-600 inline-flex items-center gap-2 px-5 py-2.5 text-white font-medium rounded-xl shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                        ...
                        {bot ? (
                            <>
                                ...
                                <button
                                    ...
                                    disabled={isToggling}
                                    className={`inline-flex items-center gap-2 px-5 py-2.5 text-white font-medium rounded-xl shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed ${toggleButtonColor}`}
                                >
                                    {isToggling ? (
                                        <>
                        ...
                        <div className="px-6 py-5 border-b border-gray-100 dark:border-gray-700 bg-gradient-to-r from-gray-50 to-white dark:from-gray-800 dark:to-gray-800">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    {bot && <p className="text-sm text-gray-500 dark:text-gray-400">Управление ботом</p>}
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div className="flex items-center justify-between flex-wrap gap-4">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="flex">
                                                ...
                                                <span className={`inline-flex items-center mx-3 px-3 py-1.5 rounded-full text-xs font-semibold ${
                                                    bot.is_active
                                        ...
                                        <div className="flex items-center gap-3 flex-wrap justify-end">
                                            ...
                                            <Link
                                                ...
                                                className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white text-sm font-medium rounded-lg transition-colors shadow-sm"
                                            >
                                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
