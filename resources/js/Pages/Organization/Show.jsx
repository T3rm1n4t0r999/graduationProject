                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-100 dark:border-gray-700">
                        <div className="px-6 py-5 border-b border-gray-100 dark:border-gray-700 bg-gradient-to-r from-gray-50 to-white dark:from-gray-800 dark:to-gray-800">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h2 className="text-lg font-bold text-gray-900 dark:text-white">Боты организации</h2>
                                    <p className="text-sm text-gray-500 dark:text-gray-400">{bots.meta?.total || bots.data.length} всего</p>
                                </div>
                            </div>
                        </div>
                            ...
                            {organizationBot ? (
                                <div className="space-y-4">
                                    {bots.data.map((bot, index) => (
                                        <div 
                                            key={bot.id}
                                            className="group relative bg-gradient-to-r from-gray-50 to-white dark:from-gray-700/50 dark:to-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-600 hover:border-indigo-300 dark:hover:border-indigo-500 transition-all duration-200 hover:shadow-lg"
                                        >
                                ...
                                <div className="text-center py-12">
                                    ...
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">У организации нет ботов</h3>
                                    <p className="text-gray-500 dark:text-gray-400 mb-6 max-w-md mx-auto">
                                        Создайте своего первого бота для автоматизации процессов в организации
                                    </p>
                                    <button
                                        type="button"
                                        onClick={() => setIsCreateBotModalOpen(true)}
