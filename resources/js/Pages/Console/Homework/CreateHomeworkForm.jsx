...
export default function CreateHomeworkForm({ isOpen, onClose, onSuccess, organization, lessons = null, lesson = null }) {
    ...
    // Найти выбранный урок для отображения метки
                                    ...
                                    {!lesson && (
                                        <div className="mb-4">
                                            ...
                                            <Listbox
                                                ...
                                                onChange={(value) => setData('lesson_id', value)}
                                            >
                                            ...
                                            {errors.lesson_id && <p className="mt-1 text-sm text-red-500">Поле урока обязательно</p>}
                                        </div>
                                    )}
