...
export default function CreateLessonForm({ isOpen, onClose, onSuccess, organization, modules = null, module = null }) {
    const { data, setData, post, processing, errors, reset } = useForm({
        title: '',
        description: '',
        module_id: module?.id || modules?.[0]?.id || '',
    });
    const submit = (e) => {
        e.preventDefault();
        post(
    ...
    const selectedModule = modules?.find((c) => c.id == data.module_id);
                                        ...
                                        <div className="relative">
                                            ...
                                            >
                                                    <span className={selectedModule ? 'text-main' : 'text-meta'}>
                                                        {selectedModule ? selectedModule.title : 'Выберите курс'}
                                                    </span>
